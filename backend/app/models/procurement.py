"""Procurement-domain ORM models — PurchaseOrder, POLine.

Mirrors `schema/ddl.sql` lines 755-796. PO has a state machine
...
GRN and Purchase Invoice land in TASK-028 / TASK-029 — both extend this
module rather than duplicate the same imports.
"""
